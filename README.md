...
* **Key Technologies:** HTML, CSS, Java, JavaScript
...
* **Key Technologies:** HTML, Java (used for client-side processing or templating)
...
* **Primary Technologies:** Java (96.9%), Backend Services
